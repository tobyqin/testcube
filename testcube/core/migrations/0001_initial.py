# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-06-11 04:57
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(
                    choices=[(-1, 'Pending'), (0, 'Passed'), (1, 'Analysis Required'), (2, 'Analyzed'),
                             (3, 'Abandoned')], default=-1)),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Product')),
                ('team', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Team')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='testresult',
            name='testcase',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.TestCase'),
        ),
    ]
