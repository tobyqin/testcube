# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-07-07 01:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reason',
                 models.IntegerField(choices=[(0, 'Product defect'), (1, 'Testcase defect'), (2, 'Environment issue')],
                                     default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(auto_now_add=True)),
                ('analysis', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                                  related_name='result', to='core.ResultAnalysis')),
                ('error', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                               related_name='result', to='core.ResultError')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='runs',
                                              to='core.Product')),
                ('source', models.OneToOneField(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                                to='core.ObjectSource')),
            ],
            options={
                'ordering': ['-id'],
            },
